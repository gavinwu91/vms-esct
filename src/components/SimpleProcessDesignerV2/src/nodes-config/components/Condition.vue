<template>
  <el-form ref="formRef" :model="condition" :rules="formRules" label-position="top">
    ...
    >
      ...
      <div title="Adding conditions group" class="mt-4 cursor-pointer">
        <Icon
          color="#0089ff"
          icon="ep:plus"
          :size="24"
...
const formRules = reactive({
  conditionType: [{ required: true, message: '配置方式 can not empty', trigger: 'blur' }],
  conditionExpression: [{ required: true, message: '条件表达式 can not empty', trigger: 'blur' }]
})
