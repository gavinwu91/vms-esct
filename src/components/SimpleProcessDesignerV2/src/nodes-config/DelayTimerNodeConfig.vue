...
const formRules = reactive({
  delayType: [{ required: true, message: '延迟时间 can not empty', trigger: 'change' }],
  timeDuration: [{ required: true, message: '延迟时间 can not empty', trigger: 'change' }],
  dateTime: [{ required: true, message: '延迟时间 can not empty', trigger: 'change' }]
})
// 配置表单数据
