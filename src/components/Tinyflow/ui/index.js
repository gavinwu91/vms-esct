  ...
  return dn(e, ut(
    ...
    () => r,
    {
      ...
      children: (c, f) => {
        ...
        $t(K, {
          rows: 5,
          placeholder: "Please input 系统提示词",
          style: "width: 100%",
          get value() {
            return h(ie);
          },
        ...
        $t(W, {
          rows: 5,
          placeholder: "Please input 用户提示词",
          style: "width: 100%",
          get value() {
            return h(ue);
          },
  ...
  return dn(e, ut(
    ...
    () => r,
    {
      ...
      children: (u, c) => {
        ...
        $t(b, {
          rows: 10,
          placeholder: "Please input 执行代码，注：输出内容需添加到_result中，如：_result.put(key, value)",
          style: "width: 100%",
          onchange: (A) => {
        ...
        var se = z(ze, 2);
        {
          var Te = (oe) => {
            ...
            $t(xe, {
              rows: "5",
              style: "width: 100%",
              placeholder: "Please input  json 信息",
              get value() {
                return n().bodyJson;
              },
              oninput: (Oe) => {
  ...
  return Nr(() => {
    ...
    () => r,
    {
      ...
      children: (c, f) => {
        ...
        var E = z(b, 4), M = X(E);
        xt(M, { placeholder: "Please input 关键字", style: "width: 100%" }), Z(E);
        var D = z(E, 4), V = X(D);
        xt(V, { placeholder: "搜索的数据条数", style: "width: 100%" }), Z(D);
        var A = z(D, 4), O = X(A);
        $t(O, {
          rows: 3,
          placeholder: "Please input 其他参数（Property 格式）",
          style: "width: 100%"
        }), Z(A);
        var R = z(A, 2), S = X(R);
        Ge(S, {
