...
const set = () => {
  ...
  //简单检查
  if (arr.length < 6) {
    ElMessage.warning('Cron wrong,already transfer default cron')
    arr = '* * * * * ?'.split(' ')
  }
...
<template>
  <el-input v-model="defaultValue" class="input-with-select" v-bind="$attrs" @input="inputChange">
    <template #append>
      <el-select v-model="select" placeholder="Generate" style="width: 115px">
        <el-option label="Every minute" value="0 * * * * ?" />
        <el-option label="Every hour" value="0 0 * * * ?" />
        <el-option label="Every day 00:00" value="0 0 0 * * ?" />
        <el-option label="Every month first day 00:00" value="0 0 0 1 * ?" />
        <el-option label="Every month last day 00:00" value="0 0 0 L * ?" />
        <el-option label="Every sunday 00:00" value="0 0 0 ? * 1" />
        <el-option
      ...
      <el-tabs>
          ...
          <el-form>
            <el-form-item label=" Type">
              <el-radio-group v-model="cronValue.second.type">
                ...
                <el-radio-button value="2">Loop</el-radio-button>
                <el-radio-button value="3">Appoint</el-radio-button>
              </el-radio-group>
            </el-form-item>
            ...
            <el-form-item v-if="cronValue.second.type == '2'" label="loop">
              <el-input-number
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.minute.type == '2'" label="Loop">
              <el-input-number
            ...
            <el-form-item v-if="cronValue.minute.type == '3'" label="Appoint">
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.hour.type == '2'" label="Loop">
              <el-input-number
            ...
            <el-form-item v-if="cronValue.hour.type == '3'" label="Appoint">
          ...
          <el-form>
            <el-form-item label=" Type">
              <el-radio-group v-model="cronValue.day.type">
                ...
                <el-radio-button value="2">Loop</el-radio-button>
                <el-radio-button value="3">Appoint</el-radio-button>
                <el-radio-button value="4">Month last day</el-radio-button>
                <el-radio-button value="5">No Appoint</el-radio-button>
              </el-radio-group>
            </el-form-item>
            ...
            <el-form-item v-if="cronValue.day.type == '2'" label="Loop">
              <el-input-number
            ...
            <el-form-item v-if="cronValue.day.type == '3'" label="Appoint">
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.month.type == '2'" label="Loop">
              <el-input-number
            ...
            <el-form-item v-if="cronValue.month.type == '3'" label="Appoint">
            ...
            <el-form>
              <el-form-item label=" Type">
                <el-radio-group v-model="cronValue.week.type">
                  ...
                  <el-radio-button value="2">Loop</el-radio-button>
                  <el-radio-button value="3">Appoint</el-radio-button>
                  <el-radio-button value="4">Month last Week</el-radio-button>
                  <el-radio-button value="5">No Appoint</el-radio-button>
                </el-radio-group>
              </el-form-item>
              ...
              <el-form-item v-if="cronValue.week.type == '2'" label="Loop">
                The
                <el-input-number
              ...
              <el-form-item v-if="cronValue.week.type == '3'" label="Appoint">
              ...
              <el-form-item v-if="cronValue.week.type == '4'" label="Last Week">
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.year.type == '2'" label="Loop">
            ...
            <el-form-item v-if="cronValue.year.type == '3'" label="Appoint">
