<template>
  <div class="panel-tab__content">
    ...
    <!--        <el-table-column label="字段 Name" prop="label" min-width="80px" show-overflow-tooltip />-->
    <!--        <el-table-column-->
    <!--          label="字段 Type"-->
    <!--          prop="type"-->
    <!--          min-width="80px"-->
    ...
    <!--            placeholder="Please select 字段 Type"-->
    <!--            clearable-->
    ...
    <!--          </el-select>-->
    <!--        </el-form-item>-->
    <!--        <el-form-item label="类型 Name" v-if="formFieldForm.typeType === 'custom'">-->
    ...
    <!--          <el-table-column label="枚举值 Name" prop="name" min-width="100px" show-overflow-tooltip />-->
    <!--          <el-table-column label="Operate" width="90px">-->
    <!--            <template #default="scope">-->
    <!--              <el-button-->
    <!--                type="primary"-->
    ...
    <!--        <el-table-column label="序号" width="50px" type="index" />-->
    <!--        <el-table-column label="约束 Name" prop="name" min-width="100px" show-overflow-tooltip />-->
