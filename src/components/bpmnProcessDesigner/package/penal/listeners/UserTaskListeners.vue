<template>
  <div class="panel-tab__content">
    <el-table :data="elementListenersList" size="small" border>
      ...
      />
      <el-table-column label="Operate" width="90px">
    ...
    >
      <el-form size="small" :model="listenerForm" label-width="96px" ref="listenerFormRef">
        ...
        <template v-if="listenerForm.listenerType === 'scriptListener'">
          <el-form-item
            ...
            :rules="{ required: true, trigger: ['blur', 'change'], message: 'Please fill in 脚本格式' }"
          >
          ...
          <el-form-item
            ...
            prop="value"
            key="listener-script"
            :rules="{ required: true, trigger: ['blur', 'change'], message: 'Please fill in 脚本内容' }"
          >
          ...
          <el-form-item
            ...
            :rules="{ required: true, trigger: ['blur', 'change'], message: 'Please fill in Resources Address' }"
          >
        ...
        <template v-if="listenerForm.event === 'timeout'">
          <el-form-item label="定时器 Type" prop="eventDefinitionType" key="eventDefinitionType">
          ...
          <el-form-item
            ...
            :rules="{ required: true, trigger: ['blur', 'change'], message: 'Please fill in 定时器配置' }"
          >
      ...
      <p class="listener-filed__title">
        <span><Icon icon="ep:menu" />Injection field：</span>
      ...
      >
        <el-table-column label="序号" width="50px" type="index" />
        <el-table-column label="字段 Name" min-width="100px" prop="name" />
        <el-table-column
          label="字段 Type"
          min-width="80px"
          show-overflow-tooltip
...
const listenerFieldFormModelVisible = ref(false) // 监听器 注入字段表单弹窗 显示 Status
