<template>
  <div class="panel-tab__content">
    ...
    <el-table :data="messageList" border>
      ...
      <el-table-column label="消息 Name" prop="name" max-width="300px" show-overflow-tooltip />
    </el-table>
    <div
    ...
    <el-table :data="signalList" border>
      ...
      <el-table-column label="信号 Name" prop="name" max-width="300px" show-overflow-tooltip />
    </el-table>
