  ...
  <div class="panel-tab__content">
    ...
    <el-form label-width="90px" style="display: none">
      ...
      >
        ...
        <!-- add by vms：由于「元素变量」暂时用不到，所以这里 display 为 none -->
        ...
        <!-- add by vms：由于「异步 Status」暂时用不到，所以这里 display 为 none -->
        <el-form-item label="异步 Status" key="async" style="display: none">
          <el-checkbox
