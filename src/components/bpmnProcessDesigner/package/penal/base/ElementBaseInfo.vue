  ...
  <div class="panel-tab__content">
    <el-form label-width="90px" :model="needProps" :rules="rules">
      <div v-if="needProps.type == 'bpmn:Process'">
        ...
        <el-form-item label="流程 mark" prop="id">
          <el-input
            v-model="needProps.id"
            placeholder="Please input 流标 mark"
...
const rules = reactive({
  id: [{ required: true, message: '流程标识 can not empty', trigger: 'blur' }],
...
// TODO vms：documentation 暂时无法修改，后续在看看
