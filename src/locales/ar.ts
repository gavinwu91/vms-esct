export default {
  common: {
    inputText: 'الرجاء إدخال',
    selectText: 'الرجاء اختيار',
    startTimeText: 'بدء وقت البدء',
    endTimeText: 'نهاية الوقت',
    login: 'ـ المنطق',
    required: 'وهذا أمر مطلوب',
    loginOut: 'تسجيل الدخول إلى',
    document: 'مستند',
    profile: 'مركز المستخدم',
    reminder: 'تذكير عن',
    loginOutMessage: 'هل خرج النظام؟',
    back: 'ظهر',
    ok: 'حسناً',
    save: 'أنقذ',
    cancel: 'أَلْغَى',
  ...
  profile: {
    ...
    rules: {
      nickname: 'يرجى إدخال اسم المستخدم',
      mail: 'يرجى إدخال عنوان البريد الإلكتروني',
      truemail: 'يرجى إدخال عنوان البريد الإلكتروني الصحيح',
      phone: 'الرجاء إدخال رقم الهاتف',
      truephone: 'الرجاء إدخال رقم الهاتف الصحيح'
    },
    password: {
      oldPassword: 'كلمة سر قديمة',
      newPassword: 'كلمة سر جديدة',
      confirmPassword: 'تأكيد كلمة المرور',
      oldPwdMsg: 'الرجاء إدخال كلمة المرور القديمة',
      newPwdMsg: 'الرجاء إدخال كلمة سر جديدة',
      cfPwdMsg: 'يرجى إدخال تأكيد كلمة المرور',
      diffPwd: 'دخلت كلمات المرور مرتين لا مباراة'
    }
  },
  cropper: {
