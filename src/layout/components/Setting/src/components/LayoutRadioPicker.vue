...
<template>
  <div :class="prefixCls" class="flex flex-wrap space-x-14px">
    ...
    <div
      :class="[
        `${prefixCls}__vms-ui`,
        'relative w-56px h-48px cursor-pointer bg-[#0b1120]',
        {
          'is-acitve': layout === 'vmsUi'
        }
      ]"
      @click="appStore.setLayout('vmsUi')"
      title="vmsUi"
    >
      <div class="absolute left-0 top-0 h-full w-[33%] bg-[#020617]"></div>
    </div>
  </div>
</template>
