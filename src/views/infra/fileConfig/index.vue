<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="Main config" align="center" prop="primary">
        <template #default="scope">
      ...
      />
      <el-table-column label="Operate" align="center" width="240px">
        <template #default="scope">
          <el-button
            link
            type="primary"
...
const handleTest = async (id) => {
  try {
    ...
    await message.confirm('是否要访问该文件？', 'Test 上传 success')
