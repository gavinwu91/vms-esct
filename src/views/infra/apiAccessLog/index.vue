<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="Log type" align="center" prop="operateType">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.INFRA_OPERATE_TYPE" :value="scope.row.operateType" />
        </template>
      </el-table-column>
      <el-table-column label="Operate" align="center" fixed="right" width="60">
        <template #default="scope">
          <el-button
            link
            type="primary"
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, 'API visit log.xls')
  } catch {
  } finally {
