<template>
  <el-form ref="formRef" :model="formData" :rules="rules" label-width="150px">
    <el-row>
      <el-col :span="12">
        <el-form-item label="生成Template " prop="templateType">
      ...
      <el-col :span="12">
        <el-form-item label="前端 Type" prop="frontType">
      ...
      <el-col :span="12">
        <el-form-item>
          ...
          <el-tree-select
            ...
            check-strictly
            node-key="id"
            placeholder="Please select 系统菜单"
          />
        </el-form-item>
      </el-col>
    ...
    <el-row v-if="formData.templateType == 2">
      ...
      <el-col :span="12">
        <el-form-item prop="treeParentColumnId">
          <template #label>
            <span>
              父编号字段
              <el-tooltip content="树显示的父 code字段名， 如：parent_Id" placement="top">
                <Icon icon="ep:question-filled" />
              </el-tooltip>
            </span>
          </template>
          <el-select v-model="formData.treeParentColumnId" placeholder="Please select ">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item prop="treeNameColumnId">
          ...
          <el-select v-model="formData.treeNameColumnId" placeholder="Please select ">
            <el-option
              v-for="(column, index) in props.columns"
              :key="index"
              :label="column.columnName + '：' + column.columnComment"
    ...
    <el-row v-if="formData.templateType == 15">
      ...
      <el-col :span="12">
        <el-form-item prop="masterTableId">
          ...
          <el-select v-model="formData.masterTableId" placeholder="Please select ">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item prop="subJoinColumnId">
          ...
          <el-select v-model="formData.subJoinColumnId" placeholder="Please select ">
            <el-option
              v-for="(column, index) in props.columns"
              :key="index"
              :label="column.columnName + '：' + column.columnComment"
      ...
      <el-col :span="12">
        <el-form-item prop="subJoinMany">
          ...
          <el-radio-group v-model="formData.subJoinMany" placeholder="Please select ">
