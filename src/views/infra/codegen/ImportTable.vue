<template>
  <Dialog v-model="dialogVisible" title="导入表" width="800px">
    ...
    <el-form ref="queryFormRef" :inline="true" :model="queryParams" label-width="68px">
      ...
      <el-form-item label="表 Name" prop="name">
        <el-input
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column :show-overflow-tooltip="true" label="表 Name" prop="name" />
