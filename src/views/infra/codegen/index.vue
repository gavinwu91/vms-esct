<template>
    ...
    >
      <el-form-item label="表 Name" prop="tableName">
        <el-input
          ...
          class="!w-240px"
          clearable
          placeholder="Please input 表 Name"
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" label="表 Name" prop="tableName" width="200" />
      <el-table-column
      ...
      <el-table-column
        ...
        width="180"
      />
      <el-table-column align="center" fixed="right" label="Operate" width="300px">
        <template #default="scope">
          <el-button
