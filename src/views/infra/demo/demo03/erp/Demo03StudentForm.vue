...
const formRules = reactive({
  ...
  sex: [{ required: true, message: '性别 can not empty', trigger: 'blur' }],
  birthday: [{ required: true, message: '出生日期 can not empty', trigger: 'blur' }],
  description: [{ required: true, message: '简介 can not empty', trigger: 'blur' }]
})
