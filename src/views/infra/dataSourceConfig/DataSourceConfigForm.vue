<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    <el-form
      ...
      label-width="100px"
    >
      <el-form-item label="数据源 Name" prop="name">
        <el-input v-model="formData.name" placeholder="Please input param name" />
      </el-form-item>
      <el-form-item label="数据源连接" prop="url">
        <el-input v-model="formData.url" placeholder="Please input 数据源连接" />
      </el-form-item>
      <el-form-item label="用户名" prop="username">
        <el-input v-model="formData.username" placeholder="Please input 用户名" />
      </el-form-item>
      <el-form-item label="密码" prop="password">
        <el-input v-model="formData.password" placeholder="Please input 密码" />
      </el-form-item>
    </el-form>
    <template #footer>
...
const formRules = reactive({
  name: [{ required: true, message: '数据源名称 can not empty', trigger: 'blur' }],
  url: [{ required: true, message: '数据源连接 can not empty', trigger: 'blur' }],
