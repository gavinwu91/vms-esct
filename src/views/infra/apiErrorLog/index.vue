<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="处理 Status" prop="processStatus">
        <el-select
          v-model="queryParams.processStatus"
          placeholder="Please select 处理 Status"
          clearable
          class="!w-240px"
        >
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column label="Log id" align="center" prop="id" />
      ...
      <el-table-column label="处理 Status" align="center" prop="processStatus">
        <template #default="scope">
          <dict-tag
