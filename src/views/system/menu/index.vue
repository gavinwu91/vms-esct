  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button plain type="danger" @click="toggleExpandAll" class="vms-track-button">
          <Icon class="mr-5px" icon="ep:sort" />
          Expand/Collapse
        </el-button>
        <el-button plain @click="refreshMenu" class="vms-track-button">
          <Icon class="mr-5px" icon="ep:refresh" />
          Refresh menu cache
        </el-button>
      </el-form-item>
...
const refreshMenu = async () => {
  try {
    await message.confirm('Will update the cache to refresh the browser!', 'Refresh menu cache')
    // 清空，从而触发刷新
