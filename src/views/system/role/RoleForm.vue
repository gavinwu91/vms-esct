  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      <el-form-item label="Role  Name" prop="name">
        <el-input v-model="formData.name" placeholder="Please input Role Name" />
      </el-form-item>
      <el-form-item label="Role  mark" prop="code">
        <el-input v-model="formData.code" placeholder="Please input Role mark" />
      </el-form-item>
      <el-form-item label="Sort" prop="sort">
        <el-input v-model="formData.sort" placeholder="Please input Sort" />
      </el-form-item>
...
const formRules = reactive({
  ...
  code: [{ required: true, message: 'Role code can not empty', trigger: 'change' }],
  sort: [{ required: true, message: 'Sort can not empty', trigger: 'change' }],
