  ...
  <Dialog v-model="dialogVisible" title="IP query">
    ...
    >
      <el-form-item label="IP" prop="ip">
        <el-input v-model="formData.ip" placeholder="Please input IP address" />
      </el-form-item>
      <el-form-item label="address" prop="result">
        <el-input v-model="formData.result" placeholder="展示query IP 结果" readonly />
      </el-form-item>
    </el-form>
    <template #footer>
...
const formRules = reactive({
  ip: [{ required: true, message: 'IP address can not empty', trigger: 'blur' }]
})
