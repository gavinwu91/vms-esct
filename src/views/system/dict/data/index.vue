<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column label="Dict id" align="center" prop="id" />
      <el-table-column label="Dict label" align="center" prop="label" />
      <el-table-column label="Dict value" align="center" prop="value" />
      <el-table-column label="Dict sort" align="center" prop="sort" />
...
const dictTypeList = ref<DictTypeApi.DictTypeVO[]>() // Dict type的列表
