  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="Data label" prop="label">
        <el-input v-model="formData.label" placeholder="Please input Data label" />
      </el-form-item>
      <el-form-item label="Data value" prop="value">
        <el-input v-model="formData.value" placeholder="Please input Data value" />
      </el-form-item>
      ...
      <el-form-item label="CSS Class" prop="cssClass">
        <el-input v-model="formData.cssClass" placeholder="Please input  CSS Class" />
      </el-form-item>
...
const formRules = reactive({
  label: [{ required: true, message: 'Data label can not empty', trigger: 'blur' }],
  value: [{ required: true, message: 'Data value can not empty', trigger: 'blur' }],
  sort: [{ required: true, message: 'Data sort can not empty', trigger: 'blur' }],
  status: [{ required: true, message: 'Status can not empty', trigger: 'change' }]
})
