<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    <el-form
      ...
      label-width="121px"
    >
      <el-form-item label="Dict name" prop="name">
        <el-input v-model="formData.name" placeholder="Please input Dict name" />
      </el-form-item>
...
const formRules = reactive({
  name: [{ required: true, message: 'Dict name can not empty', trigger: 'blur' }],
  type: [{ required: true, message: 'Dict type can not empty', trigger: 'blur' }],
