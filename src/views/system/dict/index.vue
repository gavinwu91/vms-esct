<template>
    ...
    >
      ...
      <el-form-item label="Dict type" prop="type">
        <el-input
          ...
          class="!w-240px"
          clearable
          placeholder="Please input Dict type"
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      <el-form-item label="Status" prop="status">
        <el-select
          ...
          class="!w-240px"
          clearable
          placeholder="Please select dict Status"
        >
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column align="center" label="Dict id" prop="id" />
      <el-table-column align="center" label="Dict name" prop="name" show-overflow-tooltip />
      <el-table-column align="center" label="Dict type" prop="type" width="300" />
