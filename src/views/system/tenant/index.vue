<template>
    ...
    >
      <el-form-item label="Tenant" prop="name">
        <el-input
          ...
          placeholder="Please input Tenant"
          clearable
      ...
      <el-form-item label="Contact phone" prop="contactMobile">
        <el-input
          ...
          placeholder="Please input Contact phone"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="Tenant Status" prop="status">
        <el-select
          ...
          placeholder="Please select Tenant Status"
          clearable
          class="!w-240px"
        >
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column label="Tenant Code" align="center" prop="id" />
      <el-table-column label="Tenant" align="center" prop="name" />
      <el-table-column label="Tenant plan" align="center" prop="packageId">
      ...
      <el-table-column label="Contact phone" align="center" prop="contactMobile" />
      <!-- <el-table-column label="Account Count" align="center" prop="accountCount">
        <template #default="scope">
      ...
      <el-table-column
        ...
        :formatter="dateFormatter"
      />
      <el-table-column label="Operate" align="center" min-width="110" fixed="right">
        <template #default="scope">
          <el-button
            link
            type="primary"
...
const packageList = ref([] as TenantPackageApi.TenantPackageVO[]) //Tenant plan列表
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, 'Tenant.xls')
  } catch {
  } finally {
