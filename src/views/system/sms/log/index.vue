<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="Template code" prop="templateId">
        <el-input
      ...
      <el-form-item label="Send Status" prop="sendStatus">
        <el-select
          ...
          placeholder="Please select Send Status"
          clearable
          class="!w-240px"
        >
          <el-option
      ...
      <el-form-item label="Receive Status" prop="receiveStatus">
        <el-select
          ...
          placeholder="Please select Receive Status"
          clearable
          class="!w-240px"
        >
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      />
      <el-table-column label="Phone Number" align="center" prop="mobile" width="120">
      ...
      <el-table-column label="Sms Content" align="center" prop="templateContent" width="300" />
      ...
      <el-table-column label="Template code" align="center" prop="templateId" />
      <el-table-column label="Sms Type" align="center" prop="templateType">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.SYSTEM_SMS_TEMPLATE_TYPE" :value="scope.row.templateType" />
        </template>
      </el-table-column>
      <el-table-column label="Operate" align="center" fixed="right" class-name="fixed-width">
        <template #default="scope">
          <el-button
            link
            type="primary"
