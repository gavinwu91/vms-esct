<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
      <el-table-column align="center" label="Code" prop="id" />
      <el-table-column align="center" label="Name" prop="name" />
      <el-table-column align="center" label="Social type" prop="socialType">
      ...
      <el-table-column align="center" label="Client Code" prop="clientId" width="180px" />
