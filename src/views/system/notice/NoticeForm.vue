  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="800">
    ...
    >
      <el-form-item label="Notice title" prop="title">
        <el-input v-model="formData.title" placeholder="Please input Notice title" />
      </el-form-item>
      <el-form-item label="Notice Content" prop="content">
        <Editor v-model="formData.content" height="150px" />
      </el-form-item>
      <el-form-item label="Notice type" prop="type">
        <el-select v-model="formData.type" clearable placeholder="Please select Notice type">
          <el-option
...
const formRules = reactive({
  title: [{ required: true, message: 'Notice title can not empty', trigger: 'blur' }],
  type: [{ required: true, message: 'Notice type can not empty', trigger: 'change' }],
  status: [{ required: true, message: 'Status can not empty', trigger: 'change' }],
  content: [{ required: true, message: 'Notice content can not empty', trigger: 'blur' }]
})
