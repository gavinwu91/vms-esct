<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column label="Notice id" align="center" prop="id" />
      <el-table-column label="Notice title" align="center" prop="title" />
      <el-table-column label="Notice type" align="center" prop="type">
...
const handlePush = async (id: number) => {
  try {
    // 推送的二次确认
    await message.confirm('Push the selected notification？')
    // 发起推送
    await NoticeApi.pushNotice(id)
    message.success(t('Push success'))
  } catch {}
}
