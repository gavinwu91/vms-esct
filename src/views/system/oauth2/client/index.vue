<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="Status" prop="status">
        <el-select v-model="queryParams.status" placeholder="Please select Status" clearable class="!w-240px">
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column label="Client Code" align="center" prop="clientId" />
      <el-table-column label="Client Secret" align="center" prop="secret" />
      ...
      <el-table-column label="授权 Type" align="center" prop="authorizedGrantTypes">
        <template #default="scope">
          <el-tag
