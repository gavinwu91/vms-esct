<template>
  <el-form ref="formRef" :model="modelData" label-width="120px" class="mt-20px">
    ...
    <el-form-item v-if="modelData.processIdRule" class="mb-20px">
      <template #label>
        <el-text size="large" tag="b">流程 code</el-text>
      </template>
      <div class="flex flex-col">
        <div>
          <el-input
        ...
        <div class="ml-22px" v-if="modelData.processIdRule.enable">
          <el-text type="info">  code示例：{{ numberExample }} </el-text>
        </div>
      </div>
    </el-form-item>
    <el-form-item class="mb-20px">
        ...
        <el-radio-group v-model="modelData.titleSetting.enable">
          <div class="flex flex-col">
            ...
            <el-radio :value="true">
              自定义标题
              <el-text>
                <el-tooltip content="输入字符 '{' 即可插入Form column" effect="light" placement="top">
    ...
    >
      ...
      <div class="flex flex-col">
        ...
        <el-select
          ...
          multiple
          placeholder="Please select 要展示的Form column"
        >
          <el-option
