<template>
  <el-form ref="formRef" :model="modelData" :rules="rules" label-width="120px" class="mt-20px">
    <el-form-item label="表单 Type" prop="formType" class="mb-20px">
    ...
    <el-form-item v-if="modelData.formType === BpmModelFormType.CUSTOM" label="表单提交路由" prop="formCustomCreatePath">
      <el-input
        ...
        placeholder="Please input 表单提交路由"
        style="width: 330px"
      />
      <el-tooltip
        class="item"
    ...
    <el-form-item v-if="modelData.formType === BpmModelFormType.CUSTOM" label="表单查看地址" prop="formCustomViewPath">
      <el-input
        ...
        placeholder="Please input 表单查看的组件地址"
        style="width: 330px"
      />
      <el-tooltip
        class="item"
...
const rules = {
  formType: [{ required: true, message: '表单 type can not empty', trigger: 'blur' }],
  formId: [{ required: true, message: '流程表单 can not empty', trigger: 'blur' }],
  formCustomCreatePath: [{ required: true, message: '表单提交路由 can not empty', trigger: 'blur' }],
  formCustomViewPath: [{ required: true, message: '表单查看地址 can not empty', trigger: 'blur' }]
}
