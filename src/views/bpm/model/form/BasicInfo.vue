<template>
  <el-form ref="formRef" :model="modelData" :rules="rules" label-width="120px" class="mt-20px">
    <el-form-item label="流程 mark" prop="key" class="mb-20px">
      <div class="flex items-center">
        <el-input
          class="!w-440px"
          v-model="modelData.key"
          :disabled="!!modelData.id"
          placeholder="Please input 流程标识，以字母或下划线开头"
        />
        <el-tooltip
          class="item"
    ...
    <el-form-item label="流程 Name" prop="name" class="mb-20px">
      <el-input
        v-model="modelData.name"
        :disabled="!!modelData.id"
        clearable
        placeholder="Please input 流程 Name"
      />
    </el-form-item>
    <el-form-item label="流程分类" prop="category" class="mb-20px">
      <el-select
        ...
        clearable
        placeholder="Please select 流程分类"
      >
        <el-option
    ...
    <el-form-item label="流程 Type" prop="type" class="mb-20px">
    ...
    <el-form-item label="谁可以发起" prop="startUserType" class="mb-20px">
      <el-select
        ...
        placeholder="Please select 谁可以发起"
...
const rules = {
  name: [{ required: true, message: '流程名称 can not empty', trigger: 'blur' }],
  key: [{ required: true, message: '流程标识 can not empty', trigger: 'blur' }],
  category: [{ required: true, message: '流程分类 can not empty', trigger: 'blur' }],
  type: [{ required: true, message: '是否可见 can not empty', trigger: 'blur' }],
  visible: [{ required: true, message: '是否可见 can not empty', trigger: 'blur' }],
  managerUserIds: [{ required: true, message: '流程管理员 can not empty', trigger: 'blur' }]
}
