    ...
    <el-col :span="16">
      <ContentWrap title="申请信息">
        <el-form
          ...
          label-width="80px"
        >
          <el-form-item label="请假 Type" prop="type">
            <el-select v-model="formData.type" clearable placeholder="Please select 请假 Type">
              <el-option
          ...
          <el-form-item label="开始时间" prop="startTime">
            <el-date-picker
              ...
              clearable
              placeholder="Please select 开始时间"
              type="datetime"
              value-format="x"
            />
          </el-form-item>
          <el-form-item label="结束时间" prop="endTime">
            <el-date-picker
              ...
              clearable
              placeholder="Please select 结束时间"
              type="datetime"
              value-format="x"
            />
          </el-form-item>
          <el-form-item label="原因" prop="reason">
            <el-input v-model="formData.reason" placeholder="Please input 请假原因" type="textarea" />
          </el-form-item>
          <el-form-item>
...
const formRules = reactive({
  type: [{ required: true, message: '请假 type can not empty', trigger: 'blur' }],
  reason: [{ required: true, message: '请假原因 can not empty', trigger: 'change' }],
  startTime: [{ required: true, message: '请假开始时间 can not empty', trigger: 'change' }],
  endTime: [{ required: true, message: '请假结束时间 can not empty', trigger: 'change' }]
})
