    ...
    >
      <el-form-item label="" prop="name">
        <el-input
          ...
          class="!w-240px"
          clearable
          placeholder="Please input 任务 Name"
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column
        ...
        width="180"
      />
      <el-table-column align="center" label="审批 Status" prop="status" width="120">
        <template #default="scope">
      ...
      <el-table-column align="center" label="Operate" fixed="right" width="80">
        <template #default="scope">
