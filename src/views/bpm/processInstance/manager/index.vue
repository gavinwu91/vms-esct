<template>
  ...
  <ContentWrap>
    ...
    >
      <el-form-item label="发起人" prop="startUserId">
        <el-select v-model="queryParams.startUserId" placeholder="Please select 发起人" class="!w-240px">
          <el-option
      ...
      <el-form-item label="流程 Name" prop="name">
        <el-input
      ...
      <el-form-item label="所属流程" prop="processDefinitionId">
        <el-input
          ...
          placeholder="Please input 流程定义的编号"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="流程 Status" prop="status">
        <el-select
          v-model="queryParams.status"
          placeholder="Please select 流程 Status"
          clearable
          class="!w-240px"
        >
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column label="流程 Name" align="center" prop="name" min-width="200px" fixed="left" />
      <el-table-column
        label="流程分类"
        align="center"
        prop="categoryName"
      ...
      <el-table-column label="流程 Status" prop="status" width="120">
      ...
      <el-table-column label="Operate" align="center" fixed="right" width="180">
        <template #default="scope">
          <el-button
            link
            type="primary"
...
const handleCancel = async (row) => {
  // 二次确认
  const { value } = await ElMessageBox.prompt('Please input取消原因', '取消流程', {
