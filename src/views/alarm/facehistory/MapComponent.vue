<template>
  <div ref="mapContainer" class="map-container">
    ...
    <!-- <div ref="popupRef">
      <p>Alarm time:&nbsp; 324324324324</p>
      <p>Camera type:&nbsp; ddsfdsfds</p>
      <p>Camera Name:&nbsp; 23213213</p>
      <p>Area name:&nbsp; cgvsdsfdsfd</p>
    </div> -->
  </div>
</template>
...
const pushCoordinates = () => {
  ...
  popupDiv.style.background = 'rgba(255,255,255,0.8)'
  ...
  popupDiv.innerHTML = `
                        <table class="alarm-table">
                            <tbody>
                              <tr>
                                  <td style="text-align:right">Alarm time</td>
                                  <td style="padding-left:10px"> ${props.locationInfo.alarmTime}</td>
                                </tr>
                              <tr>
                                  <td style="text-align:right">Camera type</td>
                                  <td style="padding-left:10px"> ${props.locationInfo.cameraType}</td>
                                </tr>
                              <tr>
                                  <td style="text-align:right">Camera name</td>
                                  <td style="padding-left:10px"> ${props.locationInfo.cameraName}</td>
                                </tr>
                              <tr>
                                  <td style="text-align:right">Area name</td>
                                  <td style="padding-left:10px"> ${props.locationInfo.areaName}</td>
                                </tr>
                              </tbody>
                          </table>
                    `
  ...
  let popupOverlay = new Overlay({
    ...
    position: fromLonLat([parseFloat(props.longitude), parseFloat(props.latitude)])
  })
