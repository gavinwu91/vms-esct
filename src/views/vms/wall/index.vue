...
//     if (!event.candidate) {
//       const url = `${config.PLAY_SERVER_URL}/v0/cameras/${camera.id}/streams/1/sdp`
//       axios
//         .post(
//           url,
...
//     const url = `${config.PLAY_SERVER_URL}/v0/cameras/${camera.id}/streams/1?session_id=${authUtil.getAccessToken()}`
//     axios
//       .delete(url)
//       .then((res) => {
